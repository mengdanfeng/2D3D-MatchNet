...
laser_reading_distance=0.01;
laser_reading_angle=30;
dist_start_next_frame=10.0;

%cam frames
dist_cam_laser=5.0;
camera_reading_distance=1.2;
camera_reading_angle=10;

%for tracking and reprojection
window_width= 10;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for chunk = start_chunk:laser_timestamps(end,2)
    ...
    while(frame_end<length(l_timestamps))
        ...
        while(getDistance(cam_global_poses{cam_frame_start}(1,4),cam_global_poses{cam_frame_start}(2,4),laser_global_poses{frame_start}(1,4), laser_global_poses{frame_start}(2,4))>dist_cam_laser)
