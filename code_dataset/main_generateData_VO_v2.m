...
save('submap_pointclouds_vo20.mat','submap_pointclouds');
...
%     pointcloud.Color = pointcloud_color;      
    ...
    submap_keypoints{submapID,1} = (key_points.Location)';
    % red color
...
for j=1:num_submap    
    ...
    for i=1:2
        [reproj_point_img_idx_list{i}, reproj_point_img_uv_list{i}] = ProjIss2Img(images{i}, cam_idx, submap_keypoints{j}, ...
    ...
    for i=1:2
        point_to_uv_correspondences{i} = ...
            getCorrespondences(images{i}, submap_keypoints{j}, cam_idx, image_features{i}, ...
...
save('submap_info_20m.mat','submap_info');
% % visualize 2d path
