...
% pcd dir
pcd_dir = strcat(base_path, '/lms_front_submap/vo_20m/',date_time);
keypoints_dir = strcat(base_path, '/lms_front_keypoints/vo_20m/', date_time);
submap_keypoints_dir = strcat(base_path, '/submap_keypoints/vo_20m/', date_time);
pcl_proj_dir = strcat(base_path, '/lms_front_proj/vo_20m/', date_time);
...
submapParams = struct;
submapParams.submap_cover_distance=20.0;   % 100 to 50
