...
date_time = '2014-12-05-11-09-10'
sift_iss_correspond_dir = '/media/mengdan/data3/robotcar/grasshopper/2d_3d_correspondences/' + date_time
...
#    date_time = '2014-07-14-15-16-36'
    ...
    submap_id = 120    #111-113, 116, 118, 120
