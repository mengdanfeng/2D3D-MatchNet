...
def input_transform_net(point_cloud, is_training, use_bn=False, bn_decay=None, K=3):
...
def feature_transform_net(inputs, is_training, use_bn=False, bn_decay=None, K=64):
